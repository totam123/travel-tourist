<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        if (empty($errors))
        {
            ...
            if ($t_images) $data['t_images'] = $t_images;
            //tiến hành insert
            $id_update = DB::update('tours', $data, 'id = '.(int)$id);
            if($id_update > 0)
            {
                $_SESSION['success'] = "Chính sửa thành công ";
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10" style="margin-top: 10px;margin-left: 17%">
                                            <img src="<?= path_url('/uploads/tours/') ?><?= isset($_SESSION['hinhanh']) ? $_SESSION['hinhanh'] : $tour['t_images'] ?>" alt="" class="img img-responsive" id="blah" title=" Logo " style="width: 100%;height: 258px;border: 1px solid #dedede">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                    <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="t_location_id">
                                                        ...
                                                        <?php if(count($locations) > 0) :?>
                                                            <?php foreach($locations as $location) :?>
                                                                <option <?= $tour['t_location_id'] == $location['id'] ? 'selected="selected"' : ''  ?> value="<?= $location['id'] ?>"> <?= $location['loc_name'] ?> </option>
                                                            <?php endforeach ;?>
                                                        <?php endif; ?>
                                                    </select>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="t_name" value="<?= isset($tour['t_name']) ? $tour['t_name'] : '' ?>"  placeholder="Tiêu đề tours" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text"  placeholder="Mã tours" readonly name="t_code_tour" id="code_sale" class="form-control" value="<?= isset($tour['t_code_tour']) ? $tour['t_code_tour'] : '' ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" min="0" placeholder=" Giá Sp" name="t_price" class="form-control" value="<?= isset($tour['t_price']) ? $tour['t_price'] : ''?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" min="0" max="1000" placeholder="Số lượng khách hàng " name="t_number_guests" class="form-control" value="<?= isset($tour['t_number_guests']) ? $tour['t_number_guests'] : '' ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="number" min="0" max="10" placeholder=" 1 - 10 (%)" name="t_sale" class="form-control" value="<?= isset($tour['t_sale']) ? $tour['t_sale'] : '0' ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="form-group" style="margin: 5px 0">
                                ...
                                <div class="col-sm-12" style="padding-left: 30px ;padding-right: 30px">
                                    <textarea name="t_schedule"  cols="10" id="prd_description" rows="3" class="form-control wysihtml5" placeholder="Lịch trình tour"><?= isset($tour['t_schedule']) ? $tour['t_schedule'] : '' ?></textarea>
                                </div>
                            ...
                            <div class="form-group" style="margin: 5px 0">
                                ...
                                <div class="col-sm-12" style="padding-left: 30px ;padding-right: 30px">
                                    <textarea name="t_policy"  cols="10" id="prd_description" rows="3" class="form-control wysihtml5" placeholder="Chính sách tour"><?= isset($tour['t_policy']) ? $tour['t_policy'] : '' ?></textarea>
                            ...
                            <div class="form-group" style="margin:5px 0">
                                ...
                                <div class="col-sm-12" style="padding-left: 30px ;padding-right: 30px">
                                    <textarea name="t_content" id="my-editor" cols="10" rows="10" class="form-control" placeholder=" Mô tả tour "><?= isset($tour['t_content']) ? $tour['t_content'] : '' ?></textarea>
