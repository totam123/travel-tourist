<?php
    $modules = 'doanhthu';
    $title_global = 'Danh Sách doanh thu trong ngày ';
    ...
    $sql = "SELECT book_tours.* ,book_tours.id as idtour ,tours.* , users.* FROM book_tours 
        ...
        WHERE book_tours.b_status = 1 AND DAY(book_tours.created_at) = DAY(NOW()) AND MONTH(book_tours.created_at) = MONTH(NOW())";
