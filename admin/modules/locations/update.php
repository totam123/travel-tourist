<?php
    $modules = 'locations';
    $title_global = 'Chỉnh sửa địa điểm ';
    require_once __DIR__ .'/../../autoload.php';
    $id = (int)Input::get('id');
    $location = DB::fetchOne('locations',' id = '.$id);
	if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        if(empty($errors))
        {
            ...
            if(!empty($loc_image)) {
                $data['loc_image'] = $loc_image;
            }
           
            //tiến hành update
            $id_update = DB::update('locations',$data, 'id = '.(int)$id);
            ...
            $_SESSION['danger'] = " Chỉnh sửa thất bại ";
        }
    }
?>
                            ...
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="loc_name" id="inputEmail3" placeholder="Hà Nội" autocomplete="off" value="<?= isset($location['loc_name']) ? $location['loc_name'] : ''?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" name="loc_sort" class="form-control" value="<?= isset($location['loc_sort']) ? $location['loc_sort'] : ''?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"> Địa điểm nổi bật </label>
                                        <div class="col-sm-9">
                                            <input type="checkbox" name="loc_hot" <?= $location['loc_hot'] == 1 ? 'checked':'' ?>  value="1" style="margin-top: 11px;"> Hót
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="radio" name="loc_status" <?= $location['loc_status'] == 1 ? 'checked':'' ?>  value="1"> Hiện 
                                            <input type="radio" name="loc_status" <?= $location['loc_status'] == 0 ? 'checked':'' ?>  value="0"> Ẩn
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9" style="margin-top: 10px;margin-left: 25%">
                                            <img src="<?= path_url('/uploads/tours/') ?><?= isset($location['loc_image']) ? $location['loc_image'] : '' ?>" alt="" class="img img-responsive" id="blah" title=" Logo " style="width: 260px;height: 258px;border: 1px solid #dedede">
