...
// auth custome | defautl flase
$config['authentication'] = function () {

    // return !Auth::guard('admins')->check() ? false : true;
    return true;
};
...
$config['licenseName'] = '123job.loca';
$config['licenseKey']  = 'QTHTQEJE69QP27AMUNFMTA5QN8YJN';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      =>  '/public/uploads/content',
