...
class PHPMailer
{
     ...
     * Khi null, tiêu đề hoàn toàn không được đặt.
     * Số nguyên @var
     */
	...
	/**
     * Kiểu nội dung MIME của tin nhắn.
     * Chuỗi @var
     */
    ...
    /**
     * Mã hóa tin nhắn.
     * Tùy chọn: "8bit", "7bit", "binary", "base64" và "có thể in được trích dẫn".
     * Chuỗi @var
     */
    public $Encoding = '8bit';

    /**
     * Giữ thông báo lỗi bưu phẩm gần đây nhất.
     * Chuỗi @var
     */
    public $ErrorInfo = '';
    ...
    protected function edebug($str)
    {
        ...
        switch ($this->Debugoutput) {
            case 'error_log':
                ...
                break;
            case 'html':
                // Dọn dẹp đầu ra một chút để có đầu ra đẹp hơn, an toàn với HTML
                echo htmlentities(
                    preg_replace('/[\r\n]+/', '', $str),
                    ENT_QUOTES,
                    'UTF-8'
